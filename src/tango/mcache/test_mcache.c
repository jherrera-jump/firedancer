...
#if FD_HAS_DEEPASAN
FD_STATIC_ASSERT( FD_MCACHE_FOOTPRINT(128UL,  0UL)==4864UL, unit_test );
FD_STATIC_ASSERT( FD_MCACHE_FOOTPRINT(128UL,  1UL)==4864UL, unit_test );
FD_STATIC_ASSERT( FD_MCACHE_FOOTPRINT(128UL,128UL)==4992UL, unit_test );
FD_STATIC_ASSERT( FD_MCACHE_FOOTPRINT(128UL,129UL)==4992UL, unit_test );
FD_STATIC_ASSERT( FD_MCACHE_FOOTPRINT(256UL,  0UL)==8960UL, unit_test );
FD_STATIC_ASSERT( FD_MCACHE_FOOTPRINT(256UL,  1UL)==8960UL, unit_test );
FD_STATIC_ASSERT( FD_MCACHE_FOOTPRINT(256UL,128UL)==9088UL, unit_test );
FD_STATIC_ASSERT( FD_MCACHE_FOOTPRINT(256UL,129UL)==9088UL, unit_test );
#else
...
FD_STATIC_ASSERT( FD_MCACHE_LG_BLOCK     ==   0, unit_test );
FD_STATIC_ASSERT( FD_MCACHE_LG_INTERLEAVE==   0, unit_test );
FD_STATIC_ASSERT( FD_MCACHE_BLOCK        == 1UL, unit_test );
