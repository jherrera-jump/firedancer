...
#if FD_HAS_DEEPASAN
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(   0UL,   0UL)==16384UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(   0UL,   1UL)==16384UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(   0UL,4096UL)==20480UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(   0UL,4097UL)==20480UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(   1UL,   0UL)==16384UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(   1UL,   1UL)==16384UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(   1UL,4096UL)==20480UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(   1UL,4097UL)==20480UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(4096UL,   0UL)==20480UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(4096UL,   1UL)==20480UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(4096UL,4096UL)==24576UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(4096UL,4097UL)==24576UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(4097UL,   0UL)==20480UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(4097UL,   1UL)==20480UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(4097UL,4096UL)==24576UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(4097UL,4097UL)==24576UL, unit_test );
#else
