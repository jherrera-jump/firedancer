...
static const uint sock_filter_policy_fd_resolv_tile_instr_cnt = 28;

static void populate_sock_filter_policy_fd_resolv_tile( ulong out_cnt, struct sock_filter out[ static 28 ], uint logfile_fd, uint accdb_ro_fd ) {
  FD_TEST( out_cnt >= 28 );
