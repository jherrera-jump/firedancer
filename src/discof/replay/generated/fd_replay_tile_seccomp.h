...
static const uint sock_filter_policy_fd_replay_tile_instr_cnt = 48;

static void populate_sock_filter_policy_fd_replay_tile( ulong out_cnt, struct sock_filter out[ static 48 ], uint logfile_fd, uint accounts_fd, uint store_fd ) {
  FD_TEST( out_cnt >= 48 );
