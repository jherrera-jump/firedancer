...
$(call add-objs,fd_gui_config_parse,fd_disco)
$(call add-objs,fd_gui_tile fd_gui fd_gui_peers fd_gui_printf generated/http_import_dist,fd_plugin_gui)
$(call make-lib,fd_plugin_gui)
$(OBJDIR)/obj/disco/gui/fd_gui_tile.o: book/public/fire.svg
$(call make-unit-test,test_live_table,test_live_table,fd_plugin_gui fd_disco fd_util)
