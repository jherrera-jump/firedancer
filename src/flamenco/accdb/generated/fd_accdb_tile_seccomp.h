...
static const uint sock_filter_policy_fd_accdb_tile_instr_cnt = 50;

static void populate_sock_filter_policy_fd_accdb_tile( ulong out_cnt, struct sock_filter out[ static 50 ], uint logfile_fd, uint accounts_fd ) {
  FD_TEST( out_cnt >= 50 );
