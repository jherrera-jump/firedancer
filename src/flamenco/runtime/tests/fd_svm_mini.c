...
fd_svm_mini_create( fd_wksp_t *                  wksp,
  ...
  FD_TEST( shmem );
  fd_accdb_t * accdb = fd_accdb_join( fd_accdb_new( accdb_join, shmem, accdb_fd, -1, NULL, 0UL, NULL ) );
  FD_TEST( accdb );
...
fd_svm_mini_reset( fd_svm_mini_t *        mini,
  ...
  fd_accdb_t * accdb = fd_accdb_join( fd_accdb_new( mini->accdb_join_mem, shmem, accdb_fd, -1, NULL, 0UL, NULL ) );
  FD_TEST( accdb );
